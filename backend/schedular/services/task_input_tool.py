...
def collect_task_input(Name, Date, Is_fixed_input, Priority, Importance, Difficulty, Start_time=None, End_time=None, Estimated_time=None, Event_id=None):
    """回傳單次任務的資料字典"""
    name = get_input(Name)
    ...
    final_event_id = Event_id if Event_id else generate_base32hex_id()
